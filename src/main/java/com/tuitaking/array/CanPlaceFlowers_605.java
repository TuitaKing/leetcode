...
public class CanPlaceFlowers_605 {
    ...
    public boolean canPlaceFlowers_leetcode(int[] flowerbed, int n) {
        int count = 0;
        for (int i = 0; i < flowerbed.length; i++) {
    ...
    public static void main(String[] args) {
        System.out.println(CanPlaceFlowers_605.canPlaceFlowers(new int[]{0,0,0,0},3));
    }
}
